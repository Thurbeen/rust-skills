...
## Non-English Trigger Tests

### Test 18: Ownership Query
...
### Test 19: Version Query

**Prompt:** "What is the latest Rust version?"
**Expected Route:** rust-learner
**Verification:**

- [ ] Uses agents, not WebSearch

### Test 20: Borrow Error Query

**Prompt:** "How to fix borrow checker errors?"
**Expected Route:** m01-ownership
**Verification:**
